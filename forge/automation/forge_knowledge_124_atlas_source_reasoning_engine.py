...
reasoning = {
    "module": "FORGE-KNOWLEDGE-124",
    "status": "ATLAS_SOURCE_REASONING_ENGINE_READY",
    "source_engine": "FORGE-KNOWLEDGE-123_ATLAS_SOURCE_SEMANTIC_ENGINE",
    ...
    "capabilities": {
        ...
        "knowledge_state_reasoning": True,
...
(RUNTIME / "source_reasoning_124.json").write_text(
    json.dumps(reasoning, indent=2)
)

(RUNTIME / "source_reasoning_124_hash.json").write_text(
    json.dumps({
        "module": "FORGE-KNOWLEDGE-124",
        "hash": hash_value
    }, indent=2)
...
with open(RUNTIME / "source_reasoning_124_ledger.jsonl", "a") as f:
    f.write(json.dumps(reasoning) + "\n")

print("FORGE-KNOWLEDGE-124 ATLAS SOURCE REASONING ENGINE READY")
