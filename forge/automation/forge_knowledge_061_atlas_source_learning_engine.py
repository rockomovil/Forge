...
learning = {
    "module": "FORGE-KNOWLEDGE-061",
    "status": "ATLAS_SOURCE_LEARNING_ENGINE_READY",
    "source_engine": "FORGE-KNOWLEDGE-060_ATLAS_SOURCE_ADAPTATION_ENGINE",
...
print("FORGE-KNOWLEDGE-061 ATLAS SOURCE LEARNING ENGINE READY")
