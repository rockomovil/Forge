...
release = {
    "module": "FORGE-KNOWLEDGE-132",
    "status": "ATLAS_SOURCE_RELEASE_ENGINE_READY",
    "source_engine": "FORGE-KNOWLEDGE-131_ATLAS_SOURCE_ARCHIVE_ENGINE",
    ...
    "capabilities": {
        "source_release_generation": True,
        "artifact_release_generation": True,
        "state_chain_release": True,
        "lineage_release": True,
        "historical_release": True,
        "certified_state_release": True,
        "immutable_state_release": True,
...
(RUNTIME / "source_release_132.json").write_text(
    json.dumps(release, indent=2)
)

(RUNTIME / "source_release_132_hash.json").write_text(
    json.dumps({
        "module": "FORGE-KNOWLEDGE-132",
        "hash": hash_value
    }, indent=2)
...
with open(RUNTIME / "source_release_132_ledger.jsonl", "a") as f:
    f.write(json.dumps(release) + "\n")

print("FORGE-KNOWLEDGE-132 ATLAS SOURCE RELEASE ENGINE READY")
