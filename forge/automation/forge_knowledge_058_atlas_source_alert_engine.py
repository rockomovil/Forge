...
alert = {
    "module": "FORGE-KNOWLEDGE-058",
    "status": "ATLAS_SOURCE_ALERT_ENGINE_READY",
    "source_engine": "FORGE-KNOWLEDGE-057_ATLAS_SOURCE_MONITORING_ENGINE",
    ...
    "capabilities": {
        ...
        "monitoring_event_detection": True,
...
print("FORGE-KNOWLEDGE-058 ATLAS SOURCE ALERT ENGINE READY")
