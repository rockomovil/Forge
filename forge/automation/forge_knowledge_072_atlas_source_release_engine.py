...
release = {
    "module": "FORGE-KNOWLEDGE-072",
    "status": "ATLAS_SOURCE_RELEASE_ENGINE_READY",
    "source_engine": "FORGE-KNOWLEDGE-071_ATLAS_SOURCE_ARCHIVE_ENGINE",
    ...
    "capabilities": {
        "source_release_validation": True,
        "archive_state_release": True,
        "locked_state_release": True,
        "sealed_state_release": True,
        "certified_state_release": True,
        "knowledge_state_release": True,
...
print("FORGE-KNOWLEDGE-072 ATLAS SOURCE RELEASE ENGINE READY")
