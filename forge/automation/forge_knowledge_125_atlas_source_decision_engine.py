...
decision = {
    "module": "FORGE-KNOWLEDGE-125",
    "status": "ATLAS_SOURCE_DECISION_ENGINE_READY",
    "source_engine": "FORGE-KNOWLEDGE-124_ATLAS_SOURCE_REASONING_ENGINE",
...
(RUNTIME / "source_decision_125.json").write_text(
    json.dumps(decision, indent=2)
)

(RUNTIME / "source_decision_125_hash.json").write_text(
    json.dumps({
        "module": "FORGE-KNOWLEDGE-125",
        "hash": hash_value
    }, indent=2)
...
with open(RUNTIME / "source_decision_125_ledger.jsonl", "a") as f:
    f.write(json.dumps(decision) + "\n")

print("FORGE-KNOWLEDGE-125 ATLAS SOURCE DECISION ENGINE READY")
