...
release = {
    "module": "FORGE-KNOWLEDGE-052",
    "status": "ATLAS_SOURCE_RELEASE_ENGINE_READY",
    "source_engine": "FORGE-KNOWLEDGE-051_ATLAS_SOURCE_ARCHIVE_ENGINE",
...
print("FORGE-KNOWLEDGE-052 ATLAS SOURCE RELEASE ENGINE READY")
