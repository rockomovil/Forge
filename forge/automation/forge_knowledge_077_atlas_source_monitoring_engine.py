...
monitoring = {
    "module": "FORGE-KNOWLEDGE-077",
    "status": "ATLAS_SOURCE_MONITORING_ENGINE_READY",
    "source_engine": "FORGE-KNOWLEDGE-076_ATLAS_SOURCE_GOVERNANCE_ENGINE",
...
print("FORGE-KNOWLEDGE-077 ATLAS SOURCE MONITORING ENGINE READY")
