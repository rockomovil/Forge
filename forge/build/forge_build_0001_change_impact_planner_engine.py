...
OUT = ROOT / "runtime/build/change_impact_plan.json"
OUT.write_text(json.dumps(report, indent=2))

print("=" * 60)
print("FORGE-BUILD-0001")
print("Change Impact Planner Engine")
print("=" * 60)
print("Target   :", root)
print("Affected :", len(impact))
print("Output   :", OUT)
print()
print("STATUS : PASS")
