...
AUDIT = json.loads(
    (ROOT / "runtime/knowledge_api/knowledge_refactoring_execution_terminal_audit.json").read_text()
)

report = {
    "module": "FORGE-KAPI-0066",
    "status": "PASS",
...
outfile = outdir / "knowledge_refactoring_execution_terminal_certification.json"
outfile.write_text(json.dumps(report, indent=2))

print("=" * 60)
print("FORGE-KAPI-0066")
print("Refactoring Execution Terminal Certification Engine")
print("=" * 60)
